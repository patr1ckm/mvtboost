...
Most procedures in the `mvtboost` package will by default automatically select the lowest number of trees provided by training, CV, or test error, which corresponds to a minimally complex model if the number of trees is not specified.
